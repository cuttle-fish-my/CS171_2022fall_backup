...
int main() {
    ...
    // cloth
    constexpr auto cloth_weight = Float(2);
    constexpr UVec2 mass_dim = {40, 30};
    constexpr auto dx_local = Float(0.1);
    constexpr auto stiffness = Float(15);
    constexpr auto damping_ratio = Float(0.0015);
    ...
    /// main Loop
    {
        ...
        auto cloth = std::make_shared<RectCloth>(cloth_weight,
                                                 mass_dim,
                                                 dx_local,
                                                 stiffness, damping_ratio, &scene.camera);
